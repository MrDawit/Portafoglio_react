...
class Tilt extends Component {
    constructor(props){
      ...
      this.reverse=this.settings.revers ? -1:1;
      this.handgleMouseEnter=this.handgleMouseEnter.bind(this,this.props.handleMouseEnter);
      this.handgleMouseMove=this.handgleMouseEnter.bind(this,this.props.handleMouseMove);
      this.handgleMouseMove=this.handgleMouseLeave.bind(this,this.props.handleMouseLeave);
    }
      componentDidMount() {
